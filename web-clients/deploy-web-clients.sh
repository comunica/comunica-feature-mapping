...
TARGET_REPO_NAME="comunica/comunica-feature-mapping-web-clients.git"

echo -e "Uploading web clients...\n"

# Checkout the target repo
targetDir=comunica-feature-mapping-web-clients
...
git commit -m "Update to comunica/comunica-feature-mapping#$GITHUB_SHA."
